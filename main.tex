...
\cventry{Spring 2025}{Kaks Database}{\href{https://github.com/pr1kol2005/kaks_db}{Github page (clickable)}}{Used tools: C++, CMake, Googletest, Gitlab CI/CD}{}{Relational database implementation (group project).}
...
\cventry{Spring 2024}{Box with molecules}{\href{https://github.com/pr1kol2005/box-with-molecules}{Github page (clickable)}}{Used tools: C++, Qt, CMake, Gitlab CI/CD}{}{A simulation of an ideal gas in an enclosed space, including a small research component to test the validity of the Maxwell distribution.}
